...
export function PackageIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8a2 2 0 0 0 1 1.73V17a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 17Z" />
...
export function LayersIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="m12.83 2.18 8.18 4.09c1.21.6 1.21 1.86 0 2.46l-8.18 4.09a2.5 2.5 0 0 1-2.66 0L2.99 8.73c-1.21-.6-1.21-1.86 0-2.46l8.18-4.09a2.5 2.5 0 0 1 2.66 0Z" />
      <path d="m2 12.43 8.2 4.1a2.5 2.5 0 0 0 2.6 0l8.2-4.1" />
      <path d="m2 17.43 8.2 4.1a2.5 2.5 0 0 0 2.6 0l8.2-4.1" />
    </svg>
  )
}
...
export function CompassIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="m16.24 7.76-1.804 5.41A2 2 0 0 1 13 14.24l-5.41 1.804A.5.5 0 0 1 7.76 14.24l1.804-5.41A2 2 0 0 1 11 7.76l5.41-1.804A.5.5 0 0 1 16.24 7.76Z" />
...
export function GithubIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M9 18H4a2 2 0 0 1-2-2v-5" />
    </svg>
  )
}
